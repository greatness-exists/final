...
const rooms = [
  ...
  },
  {
    ...
    amenities: ["Sea View", "Double Bed", "Private Bathroom", "Ari conditioning", "Wi-Fi", "Balcony"],
  ...
  },
  {
    ...
    amenities: ["Private Bathroom", "Multiple Beds", "Family Friendly", "Air Conditioning", "Wi-Fi", "Balcony"],
  ...
  },
  {
    ...
    amenities: ["Sea View", "Twin Beds", "Private Bathroom", "Air conditioning", "Balcony", "Wi-Fi"],
